...
<head>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
    ...
    <style>
      .bg-primary {
        background: -webkit-linear-gradient(left, #f70596, #fff8);
      }

      .list-group-item.active {
        z-index: 2;
        color: #fff;
        background-color: #f70596;
        border-color: #007bff;
      }

      .text-primary {
        color: #f70596 !important;
      }
    </style>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="form-inline my-2 my-lg-0" method="post" action="search.php">
        ...
        <input type="submit" class="btn btn-outline-dark" style="background-color: #f7652; color:#007bff" id="inputbtn" name="search_submit" value="Search">
      </form>
    </div>
  </nav>
</head>
